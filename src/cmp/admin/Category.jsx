...
import { API_BASE_URL, API_BASE_URL_TWO } from '../../config';
...
const Category = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await axios.get(`https://amanyademo.in.net/e_vendor_app/api/get-all-category`);
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this category?')) {
      try {
        await axios.delete(`${API_BASE_URL_TWO}/delete-category/${id}`);
